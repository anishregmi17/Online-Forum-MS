      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-item">
              <a class="nav-link " data-bs-target="#technology-hero" data-bs-toggle="collapse" href="#">
                  <i class="bi bi-journal-text"></i><span>Technologies</span><i class="bi bi-chevron-down ms-auto"></i>
              </a>
              <ul id="technology-hero" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                  <li>
                  ...
                  <li>
                      <a href="{{ route('admin.technologies.index') }}" class="active">
                          <i class="bi bi-circle"></i><span>Manage Technologies</span>
                      </a>
                  </li>
              </ul>
          </li>
 ...
 --}}
          ...
          <li class="nav-item">
              <a class="nav-link " data-bs-target="#business_plan_feature" data-bs-toggle="collapse" href="#">
                  <i class="bi bi-journal-text"></i><span>Content Policy</span><i
          ...
          <li class="nav-item">
              <a class="nav-link " data-bs-target="#faqs" data-bs-toggle="collapse" href="#">
                  <i class="bi bi-journal-text"></i><span>User Agreement</span><i
                      class="bi bi-chevron-down ms-auto"></i>
              </a>
