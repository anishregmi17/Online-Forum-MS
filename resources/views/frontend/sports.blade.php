                ...
                <div class="card mb-3" style="max-width: 800px;">
                    <div class="card-body">
                        <div class="profile-section">
                            <a href="profile.html">
                                <img src="{{ asset($sport->profileimage) }}" alt="Profile Image"
                                    style="width: 40px; height: 40px; border-radius: 50%; margin-right: 10px;" />
                                <!-- Profile icon -->
                                <span style="font-weight: bold; color: #070606;">{{ $sport->username }}</span>
                                <!-- Username -->
                            </a>
                            <span><small class="text-muted">Last updated at
                                    {{ $sport->updated_at }}</small></span>
                        </div>
                        <div style="color: black;">
                            <h5 class="card-title">{{ $sport->title }}</h5>
                            <p class="card-text" id="firstParagraph">{{ $sport->description }}</p>
                        </div>
                        <img src="{{ asset($sport->image) }}" class="card-img-top mt-3" alt="sport Image" />
